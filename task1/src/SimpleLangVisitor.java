...
public interface SimpleLangVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * labeled alternative in {@link SimpleLangParser#type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIntType(SimpleLangParser.IntTypeContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitBoolType(SimpleLangParser.BoolTypeContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitUnitType(SimpleLangParser.UnitTypeContext ctx);
	/**
